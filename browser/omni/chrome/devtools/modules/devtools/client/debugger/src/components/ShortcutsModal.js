...
loader.lazyRequireGetter(this, "_Modal", "devtools/client/debugger/src/components/shared/Modal");
...
class ShortcutsModal extends _react.Component {
  ...
  renderSearchShortcuts() {
    return _react2.default.createElement(
      ...
      this.renderShorcutItem(L10N.getStr("shortcuts.searchAgain2"), (0, _text.formatKeyShortcut)(L10N.getStr("sourceSearch.search.again.key3"))),
      ...
      this.renderShorcutItem(L10N.getStr("shortcuts.gotoLine"), (0, _text.formatKeyShortcut)(L10N.getStr("gotoLineModal.key3")))
    );
  }
