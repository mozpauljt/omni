...
loader.lazyRequireGetter(this, "_ResultList", "devtools/client/debugger/src/components/shared/ResultList");
...
class QuickOpenModal extends _react.Component {
  constructor(props) {
    ...
    this.formatSources = (0, _memoizeLast.memoizeLast)((displayedSources, tabs) => {
